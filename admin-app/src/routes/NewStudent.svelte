    ...
    const onSubmit = async () => {
        ...
        try {
            ...
            reader.addEventListener("load", async (event) => {
                ...
                const res = await fetch("http://localhost:8080/register/students/", {
                    method: "POST",
                    headers: {
...
<div class="h-full flex flex-col items-center justify-center">
    ...
    >
        ...
        <input
            ...
            required
        />
        <label for="rollNumber" class="mt-5 text-purple text-lg">Roll Number</label>
        <input
            type="text"
            id="rollNumber"
            name="rollNumber"
            ...
            required
        />
        <span class="text-purple text-lg mt-5">Student Admin ID File</span>
        <label
            for="identity"
